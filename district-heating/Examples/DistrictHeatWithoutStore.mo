...
model DistrictHeating_Examples_DistrictHeatWithoutStore
 extends DistrictHeating.Examples.DistrictHeatWithoutStore;
  annotation(experiment(StopTime=10),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_DistrictHeatWithoutStore;
