...
model DistrictHeating_Examples_Consumers_ConsumerTimeDependData
 extends DistrictHeating.Examples.Consumers.ConsumerTimeDependData;
  annotation(experiment(StopTime=10),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Consumers_ConsumerTimeDependData;
