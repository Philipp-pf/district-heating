...
model DistrictHeating_Examples_Consumers_ConsumerTimeDependExt
 extends DistrictHeating.Examples.Consumers.ConsumerTimeDependExt;
  annotation(experiment(StopTime=10),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Consumers_ConsumerTimeDependExt;
