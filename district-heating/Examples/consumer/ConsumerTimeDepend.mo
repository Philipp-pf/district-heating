...
model DistrictHeating_Examples_Consumers_ConsumerTimeDepend
 extends DistrictHeating.Examples.Consumers.ConsumerTimeDepend;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Consumers_ConsumerTimeDepend;
