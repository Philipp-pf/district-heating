...
model DistrictHeating_Examples_Boiler_BoilerInFinite
 extends DistrictHeating.Examples.Boiler.BoilerInFinite;
  annotation(experiment(StopTime=5),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Boiler_BoilerInFinite;
