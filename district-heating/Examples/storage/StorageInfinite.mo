...
model DistrictHeating_Examples_Storage_StorageInfinite
 extends DistrictHeating.Examples.Storage.StorageInfinite;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Storage_StorageInfinite;
