...
model DistrictHeating_Examples_Storage_StorageTwoLayer
 extends DistrictHeating.Examples.Storage.StorageTwoLayer;
  annotation(experiment(StopTime=10, __Dymola_NumberOfIntervals=5000),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Storage_StorageTwoLayer;
