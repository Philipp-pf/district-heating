...
model DistrictHeating_Examples_Storage_StorageFinite
 extends DistrictHeating.Examples.Storage.StorageFinite;
  annotation(experiment(StopTime=10),uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Examples_Storage_StorageFinite;
