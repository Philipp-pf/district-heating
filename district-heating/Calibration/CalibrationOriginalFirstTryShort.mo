...
model Calibration_CalibrationOriginalFirstTryShort
 extends Calibration.CalibrationOriginalFirstTryShort;
  annotation(experiment(
  StartTime=4.134e+006,
  StopTime=2.274e+007,
  Interval=60),uses(Calibration(version="0.5.0")));
end Calibration_CalibrationOriginalFirstTryShort;
