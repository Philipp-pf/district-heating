...
model DistrictHeating_Components_Consumers_ConsumerTimeDependExt
 extends DistrictHeating.Components.Consumers.ConsumerTimeDependExt;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Consumers_ConsumerTimeDependExt;
