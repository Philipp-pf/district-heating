...
model DistrictHeating_Components_Consumers_ConsumerTimeDependData
 extends DistrictHeating.Components.Consumers.ConsumerTimeDependData;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Consumers_ConsumerTimeDependData;
