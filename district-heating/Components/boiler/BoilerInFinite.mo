...
model DistrictHeating_Components_Boiler_BoilerInFinite
 extends DistrictHeating.Components.Boiler.BoilerInFinite;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Boiler_BoilerInFinite;
