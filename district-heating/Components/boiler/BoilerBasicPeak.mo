...
model DistrictHeating_Components_Boiler_BoilerBasicPeak
 extends DistrictHeating.Components.Boiler.BoilerBasicPeak;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Boiler_BoilerBasicPeak;
