...
model DistrictHeating_Components_Others_VariableThermalConductor
 extends DistrictHeating.Components.Others.VariableThermalConductor;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Others_VariableThermalConductor;
