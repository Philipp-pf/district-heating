...
model DistrictHeating_Components_Storage_StorageInfiniteLossesExt
 extends DistrictHeating.Components.Storage.StorageInfiniteLossesExt;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Storage_StorageInfiniteLossesExt;
