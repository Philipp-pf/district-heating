...
model DistrictHeating_Components_Storage_StorageInfiniteGvar
 extends DistrictHeating.Components.Storage.StorageInfiniteGvar;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Storage_StorageInfiniteGvar;
