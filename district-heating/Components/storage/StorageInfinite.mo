...
model DistrictHeating_Components_Storage_StorageInfinite
 extends DistrictHeating.Components.Storage.StorageInfinite;
  annotation(uses(DistrictHeating(version="0.6.0")));
end DistrictHeating_Components_Storage_StorageInfinite;
