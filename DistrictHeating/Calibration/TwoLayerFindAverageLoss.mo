...
equation
  ...
  connect(Store.u1, Original_heat.y) annotation (Line(points={{0,10.6},{0,10.6},
          {0,30},{0,38},{58,38},{58,70},{50.4,70}}, color={0,0,127}));
