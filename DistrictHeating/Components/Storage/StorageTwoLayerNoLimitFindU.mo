...
model StorageTwoLayerNoLimitFindU
...
Modelica.SIunits.HeatFlowRate ResultPower;
  ...
  Modelica.Blocks.Interfaces.RealInput u1 "Store Energy"      annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=270,
        origin={0,106})));
equation
...
end StorageTwoLayerNoLimitFindU;
