...
parameter Modelica.SIunits.Time TimeConstant= 28800
 ...
 parameter Real khigh1=1.1 "gain to fill store, high";
 parameter Real khigh2=1.02 "gain to fill store, low";
 parameter Real klow2=1.105 "gain to unfill store, high";
parameter Real klow1=0.95 "gain to unfill store, low";
