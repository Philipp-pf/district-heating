...
parameter Modelica.SIunits.Height Hhighload1=2.2
    "highest store load (lowest value of boarder height)";
parameter Real khigh1=1.37 "gain to fill store, high";
parameter Modelica.SIunits.Height Hhighload2=6.4
    "high store load (low value of boarder height)";
parameter Real khigh2=1.3 "gain to fill store, low";
parameter Modelica.SIunits.Height Hlowload2= 15.6
    "low store load (high value of boarder height)";
parameter Real klow2=1.1 "gain to unfill store, high";
parameter Modelica.SIunits.Height Hlowload1= 19.2
    "lowest store load (highest value of boarder height)";
parameter Real klow1=0.9 "gain to unfill store, low";
