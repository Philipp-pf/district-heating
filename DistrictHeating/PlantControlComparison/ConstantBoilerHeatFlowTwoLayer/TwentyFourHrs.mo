...
record TwentyFourHrs "Parameters for 24 hours constant boiler heat flow"

parameter Modelica.SIunits.Time TimeConstant=86400
    "time over which the boiler heat flow keeps constant";
parameter Modelica.SIunits.Height Hhighload1=4
    "highest store load (lowest value of boarder height)";
parameter Real khigh1=1.65 "gain to fill store, high";
...
parameter Real klow1=0.94 "gain to unfill store, low";
parameter Modelica.SIunits.HeatFlowRate QStart=350000
    "heat flow rate at beginning of simulation until second time period (storage losses)";
parameter Modelica.SIunits.Time TStart= 2086400
